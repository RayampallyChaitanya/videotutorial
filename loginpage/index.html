...
<body style="margin: 0px;">
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-t-85 p-b-20" style="padding-top: 0px;">
				<form class="login100-form validate-form">
					...
					<ul class="login-more p-t-190" style="text-align: center;list-style: none; padding-top: 30px;">
						<li class="m-b-8">
							<span class="txt1">
								Forgot
							</span>
						...
						<li>
							...
							<a href="../signuppage/index.html" class="txt2">
								Sign up
							</a>
						</li>
					</ul>
